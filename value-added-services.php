...
$values = [
    ...
    [
        'id' => 'travel-medical-insurance',  // Added ID
    ...
    [
        'id' => 'train-flight-bookings',  // Added ID
    ...
    [
        'id' => 'hotel-reservations',  // Added ID
    ...
    [
        'id' => 'tour-packages-europe-asia',  // Added ID
    ...
    [
        'id' => 'passport-services-pcc-renewal',  // Added ID
        'image' => 'images/value-added-services/education-loan2.jpg',
    ...
    [
        'id' => 'documents-translations-hrd-mea-apostille',  // Added ID
        'image' => 'images/value-added-services/education-loan2.jpg',
    ...
    [
        'id' => 'car-rental-services',  // Added ID
        'image' => 'images/value-added-services/education-loan2.jpg',
...
<body>
        ...
        <div class="services-banner">
            <div class="containerFull w-100">
                <div class="banner-inner  ">
                    ...
                    <!-- <p class="mt-3 col-md-6 text-white">

                        We offer a range of travel services including flight, train, and hotel reservations, along with
                        tour packages for Europe and Asia. Additionally, we provide travel insurance, passport services,
                        document translations, and car rentals
                    </p> -->
                </div>
            </div>
        </div>
        <section class="py-0">
            ...
            <div class="containerFull">
                <div class="row position-relative">
                                        ...
                                        <div class="web_content">
                                            <div class="web_content_inner">
                                                ...
                                                <?php if (isset($value['extra_content'])): ?>
                                                    <p class=""><?php echo $value['extra_content']; ?></p>
                                                <?php endif; ?>
                                                <p class="mt-3"><a class="value_box_link  fontWeight600"
                    ...
                    <div class="col-lg-5 position-relative py-5">
                        <div class="imgbox_value_box p-4 bg_secondary">
                            <img class="section-image" src="https://www.visa-consultant.com/images/value-added-services/student-travel2.jpg" alt="" />
                        </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            const valueBoxes = document.querySelectorAll('.value_box');
            const sectionImage = document.querySelector('.section-image'); // The image on the right side

            // Function to update the image src when a value_box comes into view
            const updateImage = (imageUrl) => {
                if (sectionImage) {
                    sectionImage.setAttribute('src', imageUrl); // Set the src of the image on the right
                    sectionImage.classList.add('visible'); // Make the image visible with fade-in effect
                }
            };
            ...
            const observer = new IntersectionObserver((entries, observer) => {
                entries.forEach(entry => {
                    if (entry.isIntersecting) {
                        const imageUrl = entry.target.getAttribute('data-image-url'); // Get the image URL from the data attribute
                        if (imageUrl) {
                            updateImage(imageUrl); // Update the image on the right side
                        }
                    }
                });
            }, { threshold: 0.5 }); // Trigger when 10% of the value_box is in view

            // Observe each value_box
            valueBoxes.forEach(valueBox => {
                observer.observe(valueBox);
            });
        });
