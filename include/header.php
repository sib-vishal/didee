<div class="pre-header bg_primary">
	<div class="containerFull contact-details">
		<div class="contact-details-inner">
			...
			<div class="socialLinks mt-md-3 mt-lg-0">
				<ul>
					<li><a class="facebook" href="#" title="Facebook"><i class="fab fa-facebook-square"></i> </a></li>
					...
					<li><a class="linkedin" href="#" title="LinkedIn"><i class="fa-brands fa-linkedin"></i></a></li>
